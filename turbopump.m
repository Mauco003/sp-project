function [P_el, P_upstream] = turbopump(q, K_vec, L_vec, D, rho, mu, P_downstream)
...
% 3. Friction Factor (f) - Corrected Logic
if Re <= 2300
    % Laminar Flow
    f = 64 / Re;
else
